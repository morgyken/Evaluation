...
$router->delete('delete/investigation/{id}/diagnosis', ['uses' => 'ApiController@deleteInvestigation', 'as' => 'delete_diagnosis']);
...
$router->get('get_procedures_for/{type}/{visit}', ['uses' => 'ApiController@getProceduresFor', 'as' => 'get_procedures_for']);
