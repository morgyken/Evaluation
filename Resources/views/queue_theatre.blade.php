...
?>
@extends('layouts.app')
@section('content_title','Patients Awaiting Theatre')
@section('content_description','Theatre patients')
        ...
        <table class="table table-striped">
            <tbody>
                ...
                <tr id="row_id{{$visit->visit_id}}">
                    ...
                    <td>
                        <a href="{{route('evaluation.evaluate.theatre',$visit->visit_id)}}" class="btn btn-xs btn-primary">
        ...
        <div class="modal-content">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Do you want to check out this patient from theatre?</p>
                </div>
