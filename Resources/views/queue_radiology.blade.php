...
?>
@extends('layouts.app')
@section('content_title','Patients Awaiting Radiology')
@section('content_description','Radiology Queue')
        ...
        <table class="table table-striped">
            <tbody>
                ...
                <tr id="row_id{{$visit->id}}">
                    ...
                    <td>
                        <a href="{{route('evaluation.evaluate.radiology',$visit->id)}}" class="btn btn-xs btn-primary">
        ...
        <div class="modal-content">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Do you want to check out this patient from diagnostics?</p>
                </div>
