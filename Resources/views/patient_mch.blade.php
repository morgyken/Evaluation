...
?>
@extends('layouts.app')
@section('content_title','Patient Evaluation (MCH)')
@section('content_description','Patient evaluation and Treatment(MCH)')
                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="procedures">
                            <div>
                                @include('evaluation::partials.mch.procedures')
                            </div>
                        </div>
                        @if(m_setting('evaluation.op_notes'))
