 ...
 */
extract($data);
$tests = $visit->investigations->where('type', 'ultrasound')->where('has_result', false);
                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active " id="ordered">
                            @include('evaluation::partials.ultrasound.ordered')
                        </div>
                        <div class="tab-pane" id="new">
                            @include('evaluation::partials.ultrasound.new')
                        </div>
                        <div class="tab-pane" id="results">
                            @include('evaluation::partials.ultrasound.results')
                        </div>
                    </div>
                </div>
            </div>
