...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="col-md-4">
            <div class="form-group req">
                ...
                <div class="col-md-8 input-group">
                    <input name="weight"  class="form-control bmi" type="text" value="{{$form->weight}}" id="weight"/>
            ...
            <div class="form-group req">
                ...
                <div class="col-md-8 input-group">
                    <input  name="height" class="form-control bmi" type="text" value="{{$form->height}}"  id="height"/>
                    <span class="input-group-addon">metres</span>
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label">BP Systolic</label>
                <div class="col-md-8 input-group">
                    <input  name="bp_systolic"  class="form-control" value="{{$form->bp_systolic}}"  type="text" />
                    <span class="input-group-addon">mm/hg</span>
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label">BP Diastolic</label>
                <div class="col-md-8 input-group">
                    <input  name="bp_diastolic" class="form-control" value="{{$form->bp_diastolic}}"  type="text"/>
                    <span class="input-group-addon">mm/hg</span>
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label">Pulse</label>
                <div class="col-md-8 input-group">
                    <input  name="pulse" class="form-control" type="text" value="{{$form->pulse}}" />
                    <span class="input-group-addon">per min</span>
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label">Respiration</label>
                <div class="col-md-8 input-group">
                    <input  name="respiration" class="form-control" value="{{$form->respiration}}"  type="text"/>
                    <span class="input-group-addon">per min</span>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-8 input-group">
                    <input  name="temperature" class="form-control" value="{{$form->temperature}}"  type="text"/>
        ...
        <div class="col-md-4">
            <div class="form-group">
                <label class="col-md-4 control-label">Oxygen</label>
                <div class="col-md-8 input-group">
                    <input  name="oxygen" class="form-control" type="text" value="{{$form->oxygen}}"  placeholder="Oxygen Saturation (%)"/>
                    <span class="input-group-addon">%</span>
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label">Waist</label>
                <div class="col-md-8 input-group">
                    <input  name="waist" class="form-control wh" type="text" value="{{$form->waist}}"  id="waist"  placeholder="Waist Circumference"/>
                    <span class="input-group-addon">cm</span>
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label">Hip</label>
                <div class="col-md-8 input-group">
                    <input  name="hip" class="form-control wh" type="text" value="{{$form->hip}}"  id="hip" placeholder="Hip Circumference"/>
                    <span class="input-group-addon">cm</span>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <input  name="blood_sugar" value="{{$form->blood_sugar}}"  class="form-control" type="text" />
