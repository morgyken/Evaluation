        ...
        <div class="accordion">
            ...
            <div class="treatment_item">
                ...
                <table class="table table-condensed table-borderless" id="procedures" width="100%">
                    @include('evaluation::partials.doctor.procedure_table',['_list'=>'nurse','_type'=>'nursing'])
                </table>
                {!! Form::close()!!}
            </div>
        </div>
...
<script type="text/javascript">
    var PERFOMED_URL = "{{ route('api.evaluation.performed_treatment',[$visit->id,'type'=>'nursing']) }}";
    $(function () {
