    ...
    <tbody>
        ...
        <tr id="row{{$procedure->id}}">
            ...
            <td>
                ...
                <span class="instructions"><textarea placeholder="Instructions" name="instructions[]" disabled
                                                     cols="50"></textarea></span>
            </td>
            <td>
                <input type="hidden" name="price[]" value="{{(int)$procedure->cash_charge}}" size="5"
                       id="price{{$procedure->id}}" disabled/>
                <input type="text" name="cost[]" value="{{(int)$procedure->cash_charge}}"
