        ...
        <div id="wrapper1">
            <div class="col-md-12">
                ...
                <div class="form-group {{ $errors->has('subtest') ? 'has-error' : '' }} req">
                    {!! Form::label('subtest', 'Sub Test',['class'=>'control-label col-md-4']) !!}
                    <div class="col-md-8">
                        {!! Form::select('subtest[]',get_parent_procedures(),$subtest, ['class' => 'form-control test_select', 'placeholder' => 'Choose...']) !!}
