...
?>
@extends('layouts.app')
@section('content_title','Preliminary Examinations')
@section('content_description','Preliminary Examinations')
        ...
        <table class="table table-striped">
            <tbody>
                ...
                <tr id="row_id{{$visit->visit_id}}">
                    ...
                    <td>
                        <a href="{{route('evaluation.nursing_manage',$visit->visit_id)}}" class="btn btn-xs btn-primary">
