 ...
 */
extract($data);
$investigations = $visit->investigations->whereIn('type', ['radiology', 'radiology.inpatient'])
    ->where('has_result', false);
$results = $visit->investigations->whereIn('type', ['radiology', 'radiology.inpatient'])
                    ...
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#ordered" data-toggle="tab">
                                    Ordered Procedures<span class="badge alert-info">{{$investigations->count()}}</span></a>
                            </li>
