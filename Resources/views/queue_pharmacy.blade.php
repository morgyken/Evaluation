...
?>
@extends('layouts.app')
@section('content_title','Patients Awaiting Pharmacy')
@section('content_description','Pharmacy Queue')
        ...
        <table class="table table-striped">
            <tbody>
                ...
                <tr id="row_id{{$visit->id}}">
                    ...
                    <td>
                        <a href="{{route('evaluation.evaluate.pharmacy',$visit->id)}}" class="btn btn-xs btn-primary">
